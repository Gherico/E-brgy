                          ...
                          <div class="row">
                            ...
                            <div class="col-xs-4">
                             ...
                             <select class="form-control"
                                  ...
                                  @foreach($house as $hh)
                                      <option value = "{{ $hh -> HouseID}}"> ( {{ $hh -> HouseID}} ) {{ $hh -> HFirstName}} {{ $hh -> HMidName}} {{ $hh -> HLastName}}, {{$hh -> HouseAddNo}} {{$hh -> StreetName}} St. Zone {{$hh -> HouseZone}}</option>
																	@endforeach
                              ...
                              <thead style="font-size:13px; background-color:#f0f5f5">
                                <tr>
                                  ...
                                  <th>Gender*</th>
															...
															<tbody>
																<tr>
																	<td><select id="txtRelation1" class="form-control">
                      ...
                      <tbody>
                        @foreach($res as $resi)
                          <tr>
                              ...
                              <td>{{ $resi -> HouseAddNo}} {{ $resi -> StreetName}} St. Zone {{ $resi -> HouseZone}}</td>
                  ...
                  $.ajax({
                      ...
                      success: function(data){
                        $.each(data.house, function(key, val){
                           ...
                           $('#txtAddress').val(val.HouseAddNo + " " + val.StreetName + " St. " + "Zone " + val.HouseZone);
