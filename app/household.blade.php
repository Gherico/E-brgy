              ...
              <div id="SuccessBox1"></div>
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group"  id="eStreet">
                      ...
                      <div class="col-sm-9">
                        <select class="form-control" id = "etxtstreet" name = "txt3" required="required" style="width:100%">
                            <option value="{{$street -> StreetID}}"> {{ $street -> StreetName }} St.</option>
                        </select>
                      </div>
                    </div>
                  ...
                  $('#btnSubmit').click(function(e){
                    ...
                    $.ajax({
                      ...
                      if (data.messages != null) {
                        ...
                        $('#Messages').html('<div class="alert alert-danger alert-dismissible"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><h4><i class="icon fa fa-ban"></i> Warning!</h4><b></b></div>');
                        $('#Messages').fadeIn();
                        $('#Messages').delay(3000);
                        $('#Messages').fadeOut();
                    ...
                    $.ajax({
                      ...
                      success: function(data){
                        ...
                        //alert(JSON.stringify(data.messages));
                            ...
                            $('#Messages1').html('<div class="alert alert-danger alert-dismissible"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><h4><i class="icon fa fa-ban"></i> Warning!</h4><b></b></div>');
                  ...
                  $.ajax({
                      ...
                      success: function(data){
                        $.each(data.house, function(key, val){
                          ...
                          $('#dtxt3').val(val.HouseAddNo + " " + val.HouseStreet + "Street, ");
                          // + "Zone" + val.HouseZone
